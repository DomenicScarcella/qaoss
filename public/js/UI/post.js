    ...
    dialog = $('.' + elem).dialog({
            ...
            },
            {
                ...
                click: function () {
                    ...
                    if (origin == request) {
                        ...
                        url = "https://" + request + ".ngrok.io/post/photo/post/" + content.name + '/request/' + origin + '/authToken/' + data.authToken + '/accessToken/' + data.accessToken;
                    }
                            ...
                            success: function (data, textStatus, jqXHR) {
                                ...
                                if (data.content.photo != "") {
                                    if (origin == request) {
                                        ...
                                        $('#previewbody' + index).html(data.content.body + "<br><br><a href=" + data.content.photo + "><img src=https://" + request + ".ngrok.io/" + data.content.photo + "?" + Math.random() + " width=750 height=450></a>");
        ...
        open: function (event, ui) {
            ...
            if (origin == request) {
               ...
               photo = '<img id=PhotoEdit src=https://' + request + '.ngrok.io/' + content.photo + '?' + Math.random() + '/>'
            }
            ...
            switch (key) {
                case "edit":
                    if (origin == request) {
                        ...
                        $.get("https://" + request + ".ngrok.io/post/content/" + post + "/request/" + origin + "/authToken/" + data.authToken + "/accessToken/" + data.accessToken, function (content) {

                            url = "https://" + request + ".ngrok.io/post/post/" + post;
                ...
                case "delete":
                    ...
                    if (r == true) {
                        ...
                        if (origin == request) {
                            ...
                            requestUrl = "https://" + request + ".ngrok.io/post/post/" + post + "/request/" + origin + "/authToken/" + data.authToken + "/accessToken/" + data.accessToken;
                        }
                        var id = $(this).attr('id');
                        $.ajax({
