    ...
    elem.onkeyup = function (e) {
        ...
        if (e.keyCode == 13 && !e.shiftKey) {
            ...
            if (origin == request) {
                ...
                url = "https://" + request + ".ngrok.io/comments/post/" + content + "/comment/" + encodeURIComponent(value) + "/commentindex/" + commentIndex + "/replyindex/" + replyIndex + "/request/" + origin;
            }
    ...
    elem.onkeyup = function (e) {
        if (e.keyCode == 13 && !e.shiftKey) {
            ...
            if (origin == request) {
                ...
                url = "https://" + request + ".ngrok.io/comments/post/" + content + "/comment/" + encodeURIComponent(value) + "/index/" + index + "/request/" + origin;
            }
                ...
                case "delete":
                    ...
                    if (r == true) {
                        ...
                        if (origin == request)
                            ...
                            url = "https://" + request + ".ngrok.io/comments/post/" + post + "/index/" + index + "/request/" + origin;
